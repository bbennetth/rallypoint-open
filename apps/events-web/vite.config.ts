...
// Rallypoint Events hosted UI. Same shape as apps/id-web's
// vite.config but the dev proxy points at the events-api port
// (8081) instead of the RPID api (8080). Self-hosters override
// via VITE_API_PROXY_TARGET if their events-api is elsewhere.
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'Events',
        description: 'Plan events and coordinate groups on Rallypoint.',
        start_url: '/',
        scope: '/',
        display: 'standalone',
        orientation: 'any',
