...
CREATE INDEX `fitness_sessions_user_idx` ON `sessions` (`user_id`);--> statement-breakpoint
CREATE INDEX `fitness_sessions_expires_idx` ON `sessions` (`absolute_expires_at`);--> statement-breakpoint
