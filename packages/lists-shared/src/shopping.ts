...
export const SYSTEM_MANAGED_LIST_TYPES = new Set(['shopping', 'notes', 'chores', 'diary', 'braindump'] as const)
...
export type SystemManagedListType = 'shopping' | 'notes' | 'chores' | 'diary' | 'braindump'
