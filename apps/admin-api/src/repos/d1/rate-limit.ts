...
import { rateLimits } from '@rallypoint/admin-db'
import {
...
// this stays the shared D1 repo. admin has no scheduled handler, so the D1
// branch keeps pruning opportunistically on window rollover
