...
// this stays the shared D1 repo. money has no scheduled handler, so the D1
// branch keeps the factory's inline opportunistic prune (opportunisticPrune:
// true) on window rollover; the DO backend self-cleans via per-bucket alarms
// instead.
