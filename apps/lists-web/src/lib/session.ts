...
// Lists-side session instance. The cross-subdomain SSO bootstrap +
// session-probe logic now lives in @rallypoint/web-kit's createSession
// (design §3.13); this module binds it with the lists-specific config
...
// Mirror lists-api's LISTS_SSO_STATE_COOKIE_NAME derivation
