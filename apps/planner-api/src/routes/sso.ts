...
// SSO + session-lifecycle routes (planner side of the §3.13 bootstrap). The
...
export const ssoRoutes = new Hono<HonoApp>()
  ...
  .post(
    ...
    createSsoExchangeHandler({
      ...
      stateCookieEnvKey: 'PLANNER_SSO_STATE_COOKIE_NAME',
      sessionCookieEnvKey: 'PLANNER_SESSION_COOKIE_NAME',
      keyV1EnvKey: 'PLANNER_SESSION_KEY_V1',
      keyVersionEnvKey: 'PLANNER_SESSION_KEY_VERSION',
      encryptBearer,
      readJsonBody,
      errors: {
