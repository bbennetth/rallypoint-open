...
initAnalytics('rallypoint-admin-web')
...
// Persist theme changes into the shared cross-app settings bag (debounced in
// the store). Hydration happens in getSession via hydrateThemeFromServer.
