...
// SSO + session-lifecycle routes (money side of the §3.13 bootstrap). The
...
export const ssoRoutes = new Hono<HonoApp>()
  ...
  .post(
    ...
    createSsoExchangeHandler({
      ...
      stateCookieEnvKey: 'MONEY_SSO_STATE_COOKIE_NAME',
      sessionCookieEnvKey: 'MONEY_SESSION_COOKIE_NAME',
      keyV1EnvKey: 'MONEY_SESSION_KEY_V1',
      keyVersionEnvKey: 'MONEY_SESSION_KEY_VERSION',
      encryptBearer,
      readJsonBody,
      errors: {
